...
public:
    FunDeclarationStmt(int accessModifier, Owner owner, MyType returnedType, string funId, ArgumentsStmt_ptr argStmt,
        bool isFriend);
...
public:
    ClassDefinitionStmt(int uniqueId, int accessModifier, string className,
...
public:
    FunDefinitionStmt(int accessModifier, Owner owner, MyType returnedType, string funId, ArgumentsStmt_ptr argStmt,
        BlockStmt_ptr block);
    string getStmtClassName() override { return typeid(this).name(); }
    ~FunDefinitionStmt() {};
