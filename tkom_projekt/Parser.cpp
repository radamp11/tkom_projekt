...
ClassDefinitionStmt_ptr Parser::parseClassDefinitionStmt(int access, string classId, vector<InheritedClass>& inheritedClasses)
{
	// current token is '{'
...
AddOperationStmt_ptr Parser::parseAddOperationStmt(OperationElementStmt_ptr firstOperand, bool isAdd) {
	AddOperationStmt_ptr newAddStmt(new AddOperationStmt(std::move(firstOperand), std::move(parseOperationElementStmt()), isAdd));
	return newAddStmt;
}


MultOperationStmt_ptr Parser::parseMultOperationStmt(OperationElementStmt_ptr firstOperand, bool isMult) {
	MultOperationStmt_ptr newMultStmt(new MultOperationStmt(std::move(firstOperand), std::move(parseOperationElementStmt()), isMult));
	return newMultStmt;
}
